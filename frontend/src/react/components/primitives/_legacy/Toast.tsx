...
const toneConfig: Record<ToastTone, { icon: ReactNode; classes: string }> = {
  info: {
    ...
    classes: "border-nd-accent/25 bg-nd-accent/10 text-nd-accent",
  },
  success: {
    icon: <CheckCircle2 className="h-4 w-4" />,
    classes: "border-nd-success/25 bg-nd-success/10 text-nd-success",
  },
  warning: {
    icon: <AlertCircle className="h-4 w-4" />,
    classes: "border-nd-warning/25 bg-nd-warning/10 text-nd-warning",
  },
  error: {
    icon: <XCircle className="h-4 w-4" />,
    classes: "border-nd-danger/25 bg-nd-danger/10 text-nd-danger",
  },
};
