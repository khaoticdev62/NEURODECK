...
export function DeckButtonHint({ button, label, className = '' }: DeckButtonHintProps) {
  return (
    <span
      ...
      className={`inline-flex items-center gap-1 rounded border border-nd-border-subtle bg-nd-surface-secondary/40 px-1.5 py-0.5 text-2xs text-nd-text-secondary ${className}`}
    >
