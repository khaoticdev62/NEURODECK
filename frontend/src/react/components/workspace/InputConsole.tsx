...
export function InputConsole({
  ...
  return (
    <div className="border-t border-nd-border-subtle bg-nd-surface-base/50 p-3 backdrop-blur-sm" data-controller-zone="form">
      {/* Status row */}
      ...
      {/* Composer */}
      <div className="flex items-end gap-2 rounded-2xl border border-nd-border-subtle bg-nd-surface-raised/60 p-2 shadow-sm transition focus-within:border-nd-border-focus focus-within:bg-nd-surface-raised focus-within:shadow-[0_0_12px_var(--nd-accent-primary)]">
        {/* Attachments */}
        ...
        <textarea
          ...
          rows={1}
          className="max-h-32 min-h-[40px] flex-1 resize-none bg-transparent py-2.5 text-sm leading-5 text-nd-text-primary outline-none placeholder:text-nd-text-muted"
        />
