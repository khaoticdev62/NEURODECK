  ...
  return (
    <>
      ...
      <aside
        ...
        className="group/sidebar stv-sidebar !min-w-0 !p-0 relative hidden shrink-0 flex-col border-r border-nd-text-muted/15 backdrop-blur-xl transition-all duration-200 ease-snap lg:flex"
        style={{ width: expanded ? 224 : 64, paddingTop: "16px" }}
      ...
      >
        ...
        {/* Nav sections */}
        <nav
          className="nav-tab-bar min-h-0 flex-1 overflow-y-auto px-1.5 pb-2 scrollbar-thin"
                  ...
                  {items.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={`stv-nav-item nav-tab no-drag focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-nd-accent/40 ${
                          active ? "active" : ""
