...
export function ControllerHintBar() {
  ...
  return (
    <div
      ...
      className="flex h-touch shrink-0 items-center justify-center gap-5 border-t border-[var(--nd-border-subtle)] bg-[var(--nd-surface-primary)] px-4 text-[var(--nd-text-secondary)]"
    >
