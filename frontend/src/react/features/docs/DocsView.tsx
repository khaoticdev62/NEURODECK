      ...
      >
        <div className="flex h-full flex-col gap-4 p-4">
          ...
          <div className="flex min-h-0 flex-1 gap-4">
            <Panel eyebrow="Indexed" title={`Docs (${docs.length})`} className="flex w-64 flex-col overflow-hidden">
                  ...
                  <div className="space-y-3">
                    {results.map((r) => (
                      ...
                      >
                        ...
                        <p className="mt-1 text-xs leading-relaxed text-text-secondary">{r.snippet}</p>
                      </div>
                    ))}
                  </div>
                ) : (
