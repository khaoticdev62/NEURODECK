    ...
    <div className="flex h-full flex-col">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 mb-4">
        ...
        <div className="rounded-xl border border-nd-success/20 bg-nd-success/[0.04] px-4 py-3">
          <p className="text-[10px] uppercase font-bold tracking-wider text-nd-success/80">
            Active Scripts
          </p>
        ...
        <div
          className={`rounded-xl border px-4 py-3 transition ${totalErrors > 0 ? "border-nd-danger/30 bg-nd-danger/[0.04]" : "border-nd-border-subtle bg-nd-surface-secondary/40"}`}
        >
          <p
            className={`text-[10px] uppercase font-bold tracking-wider ${totalErrors > 0 ? "text-nd-danger/80" : "text-nd-text-muted"}`}
          >
            QA Failures
          </p>
          <p
            className={`text-xl font-bold mt-0.5 ${totalErrors > 0 ? "text-nd-danger" : "text-nd-text-primary"}`}
          >
            {totalErrors}
          </p>
        </div>
                          ...
                          <div className="p-3 rounded-xl border border-nd-danger/20 bg-nd-danger/[0.03] space-y-2">
                            ...
                            <ul className="list-disc pl-4 space-y-1 text-[10px] text-nd-text-muted">
                              {report.errors.map((err, i) => (
                                <li key={i} className="text-nd-danger/90">
                                  {err}
                                </li>
                              ))}
                              {report.warnings.map((warn, i) => (
                                <li key={i} className="text-nd-warning">
                                  {warn}
                                </li>
                              ))}
                            </ul>
      ...
      >
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-sm text-nd-text">
                Allow high-risk access permissions?
              </p>
              <p className="mt-1 text-xs text-nd-text-muted">
                The plugin{" "}
                <strong className="text-nd-text font-semibold">
          ...
          <div className="rounded-xl border border-nd-danger/20 bg-nd-danger/[0.03] p-4 space-y-3">
            <h6 className="text-[10px] uppercase font-bold tracking-wider text-nd-danger">
