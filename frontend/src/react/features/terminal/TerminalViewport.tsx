              ...
              <div className="min-w-0">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <button
                    type="button"
                    onClick={onRequestRestart}
                    className="rounded-xl border border-nd-accent-primary/25 bg-nd-accent-primary/10 px-3 py-2 text-xs font-semibold text-nd-accent-primary hover:bg-nd-accent-primary/20"
                  >
                    Restart
                  </button>
                  <button
                    type="button"
                    onClick={onRequestClose}
                    className="rounded-xl border border-nd-danger/25 bg-nd-danger/10 px-3 py-2 text-xs font-semibold text-nd-danger hover:bg-nd-danger/20"
                  >
                    Close
                  </button>
                </div>
