  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
        ...
        >
          NEURO<span style={{ color: "var(--nd-accent-primary)" }}>DECK</span>
        </span>
      </div>
      ...
      <span style={{ fontSize: 12, color: "var(--nd-text-secondary)", fontWeight: 500 }}>
        {session}
      </span>

      <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 16 }}>
        <span style={metric}>
          <b style={metricVal}>{tokensPerSec}</b> tok/s
        </span>
        <span style={metric}>
          <b style={metricVal}>{vram}</b> vram
        </span>
        ...
        <span
          style={{ fontFamily: "var(--nd-font-mono)", fontSize: 12, color: "var(--nd-text-muted)" }}
        >
          {clock}
        </span>
      </div>
