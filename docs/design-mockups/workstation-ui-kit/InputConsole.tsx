...
export function InputConsole({
  ...
  persona,
  busy,
}: InputConsoleProps): React.ReactNode {
  ...
  return (
    ...
    >
      <div
        style={{
          background: "var(--nd-surface-input)",
          ...
          <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                border: "1px solid rgba(var(--nd-cyan-rgb),0.3)",
