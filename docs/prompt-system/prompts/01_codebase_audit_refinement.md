...
- For Tauri, obey the exact Tauri major version, permissions model, command registration, capabilities, config schema, and frontend/backend boundary.
- For Electron, obey main/preload/renderer separation, IPC security rules, context isolation, and packaging model.
...
Framework/runtime: [FRAMEWORK_RUNTIME_VERSION]
Package manager: [PACKAGE_MANAGER]
Target platforms: [TARGET_PLATFORMS]
Known constraints: [CONSTRAINTS]
Primary audit goal: [PRIMARY_GOAL]
```
