...
4. Document any future engineer's protocol research the same way this audit did: cite the upstream file and commit/blob SHA consulted, describe the _behavior_ learned, and never paste upstream source into NeuroDeck commits, issues, or generated code comments.
