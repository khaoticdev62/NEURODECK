...
$evalMatches = Invoke-RgJson -Pattern '\beval\s*\(|new\s+Function\s*\(' -Targets @("frontend/src", "frontend/public", "scripts") -Globs @("!frontend/dist", "!frontend/public/*.min.js", "!scripts/kfms/security_audit.py", "!scripts/verify-backend-security.ts", "!scripts/verify/verify-backend-security.ts")
