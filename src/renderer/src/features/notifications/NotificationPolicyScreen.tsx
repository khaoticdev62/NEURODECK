  ...
  return (
    <div className="flex h-full flex-col gap-4 p-4">
      ...
      <p className="text-meta text-text-secondary">
        Errors and approval requests always stay visible, even when muted categories or quiet hours
        are active.
      </p>
      ...
      <section className="flex flex-col gap-3 border border-border bg-surface p-3">
        <div className="flex items-center justify-between">
          ...
          <ControllerButton
            ...
            onClick={() =>
              setQuietHours(!policy.quietHoursEnabled, policy.quietHoursStart, policy.quietHoursEnd)
            }
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            onChange={(event) =>
              setQuietHours(policy.quietHoursEnabled, policy.quietHoursStart, event.target.value)
            }
            className="rounded-md border border-border bg-canvas p-2 text-body text-text-primary"
          />
        </div>
