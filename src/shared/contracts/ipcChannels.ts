...
export const IPC_CHANNELS = {
  ...
  backupGetSchedule: 'backup.getSchedule',
  backupSetSchedule: 'backup.setSchedule',
  ...
  deckyGetSettings: 'decky.getSettings',
  deckySetSettings: 'decky.setSettings',
  deckyGetStatus: 'decky.getStatus',
  deckyNavigate: 'decky.navigate',
  ...
  memoryGetDisabledState: 'memory.getDisabledState',
